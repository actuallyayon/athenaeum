...
export default function RegisterPage() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      toast.error("An error occurred with Google registration");
    }
  };
      ...
      <div className="max-w-md w-full bg-white rounded-sm shadow-2xl shadow-black/5 overflow-hidden border border-gray-100 relative">
        ...
        <div className="px-10 py-16">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-serif text-[#0F172A] mb-4 tracking-tight">Join <span className="text-[#D4AF37]">A</span>the<span className="text-[#D4AF37]">n</span>aeum</h2>
            <p className="text-[11px] uppercase tracking-[0.2em] text-gray-400 font-sans">Create an account to build your digital library.</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-4 bg-[#FDFBF7] border border-gray-100 rounded-sm focus:outline-none focus:ring-0 focus:border-[#D4AF37]/30 text-sm font-sans transition-all"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center py-4 px-4 rounded-full text-[11px] uppercase tracking-[0.25em] font-bold text-white bg-[#0F172A] hover:bg-gray-800 transition-all shadow-lg shadow-gray-200 cursor-pointer mt-4"
            >
          ...
          <div className="mt-12 text-center text-[10px] uppercase tracking-[0.15em] font-bold font-sans text-gray-400">
            ...
            <Link href="/login" className="text-[#D4A26A] hover:text-[#0F172A] transition-all border-b border-[#D4A26A]/30">
              Login here
            </Link>
          </div>
        </div>
